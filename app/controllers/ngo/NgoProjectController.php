...
class NgoProjectController extends BaseController
{
    ...
    {
        $title = Lang::get('project/create.titleVolunteerProject');
        // Show the page
        $categories = Category::all();
        return View::make('site/project/createVolunteerProject', compact('categories', 'title'));
    }
    ...
    {
        $title = Lang::get('project/create.editTitleVolunteerProject');
        $user = Auth::user();
        $ngo = Ngo::where('user_id', '=', $user->id)->first();
        ...
        return View::make('site/project/createVolunteerProject')->with($data);
