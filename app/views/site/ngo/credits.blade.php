...
@section('content')
	...
	<table id="credit" class="table table-striped table-hover">
		...
		<tr>
			<td class="col-md-4">
				<input class="form-control" type="text"	name="credits" id="credits" onchange="document.getElementById('total').value=parseInt(document.getElementById('credits').value)*0.01;"	value="{{{ Input::old('credits') }}}">
